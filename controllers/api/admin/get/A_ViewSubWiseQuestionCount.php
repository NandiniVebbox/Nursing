...
// Retrieve Subject Wise question count data based on admin ID, subject ID, and paper ID
$result = $obj->A_viewSubWiseQuestionCount($data->adminId, $data->subjectId, $data->paperId);
