...
if (empty($data->categoryId)) {
    respondWithError(400, 'Invalid data. Category ID is required.');
}
...
// Retrieve Subject Wise question count data based on admin ID, category ID, and paper ID
$result = $obj->A_viewNonNursingQuestionCount($data->adminId, $data->categoryId, $data->paperId);
