...
if (empty($data->adminId) || empty($data->subjectId) || empty($data->questions)) {
...
$result = $obj->A_InsertSubWiseQuestion($data->adminId, $data->subjectId, $data->paperName,$data->questions);
